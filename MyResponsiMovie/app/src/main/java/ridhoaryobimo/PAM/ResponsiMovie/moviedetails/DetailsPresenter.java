...
import ridhoaryobimo.PAM.ResponsiMovie.data.MovieReviews;
import ridhoaryobimo.PAM.ResponsiMovie.data.MovieTrailers;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.local.MovieAppDatabase;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.apis.ReviewsApiConfig;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.apis.TrailersApiConfig;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.listeners.NoConnectionListener;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.listeners.OnServiceListener;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.request.RequestHandler;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.response.GeneralResponse;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.response.ReviewsResponse;
import ridhoaryobimo.PAM.ResponsiMovie.data.source.remote.response.TrailersResponse;
import ridhoaryobimo.PAM.ResponsiMovie.util.ApplicationClass;
